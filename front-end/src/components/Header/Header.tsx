...
import headerStyles from '../../styles/UI/Header';
import HeaderRightSectionDesktop from './HeaderRightSectionDesktop';
import HeaderRightSectionMobile from './HeaderRightSectionMobile';
